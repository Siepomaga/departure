...
module ActiveRecord
  ...
  module ConnectionAdapters
    class DepartureAdapter < AbstractMysqlAdapter
      ...
      def exec_insert(sql, name = nil, binds = [], pk = nil, sequence_name = nil, returning: nil) # rubocop:disable Lint/UnusedMethodArgument, Metrics/LineLength, Metrics/ParameterLists
        execute(to_sql(sql, binds), name)
      end
